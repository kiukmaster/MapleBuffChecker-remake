...
export const SKILLS = [
  ...
  {
    id: 'golnus', name: '골누스', category: 'hunting',
    template: '/detect/lucid/golnus_{res}_{dur}sec.png', durationSelect: true, defaultDuration: 5,
    threshold: 0.92, icon: '/detect/lucid/golnus.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/골누스.wav' }),
    alert: instant(),
  },
  {
    id: 'SD1', name: '숨돌[라라링크]1', category: 'hunting',
    template: '/detect/SD/SD1_{res}.png', threshold: 0.91, icon: '/detect/SD/icon.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/숨돌.mp3' }),
    alert: instant(),
  },
  {
    id: 'SD2', name: '숨돌[라라링크]2', category: 'hunting',
    template: '/detect/SD/SD2_{res}.png', threshold: 0.91, icon: '/detect/SD/icon.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/숨돌.mp3' }),
    alert: instant(),
  },
  {
    id: 'SD3', name: '숨돌[라라링크]3', category: 'hunting',
    template: '/detect/SD/SD3_{res}.png', threshold: 0.91, icon: '/detect/SD/icon.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/숨돌.mp3' }),
    alert: instant(),
  },
  {
  ...
  {
    id: 'rr', name: '리스트레인트링', category: 'boss',
    template: '/detect/ring/rr_{res}.png', threshold: 0.98, icon: '/detect/ring/rr.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/시드링교체.wav' }),
    alert: instant(),
  },
  {
    id: 'wp', name: '웨폰퍼프링', category: 'boss',
    template: '/detect/ring/wp_{res}.png', threshold: 0.98, icon: '/detect/ring/wp.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/시드링교체.wav' }),
    alert: instant(),
  },
  {
    id: 'ct', name: '컨티뉴어스링', category: 'boss',
    template: '/detect/ring/ct_{res}.png', threshold: 0.91, icon: '/detect/ring/ct.png',
    sounds: withAlarms({ 기본음성: '/sound/detect/컨티.wav' }),
    alert: instant(),
  },
  {
