...
// delayed/timer descriptors are produced inline where needed (see SKILLS).
...
export const SKILLS = [
  ...
  // ── 보스 (boss) ─────────────────────────────────────────────────────────
  {
    ...
    sounds: withAlarms({ '기본음성(3초전)': '/sound/detect/일필5초.wav', '10초전음성': '/sound/detect/일필10초.wav' }),
    alert: { mode: 'timer', countdownSec: 28, ignoreMs: 10000, defaultLeadSec: 3, leadOptions: [3, 10] },
  },
  {
  ...
  {
    // 숨돌[레테] — rings once the moment it's detected (no delay/cooldown).
    id: 'letheBreath', name: '숨돌[레테]', category: 'job',
    template: '/detect/lethe/숨돌감지_{res}.png', threshold: 0.96, icon: '/detect/lethe/소환수감지.png',
    sounds: withAlarms({ 기본음성: '/sound/숨돌.wav' }),
    alert: instant(),
  },
];
